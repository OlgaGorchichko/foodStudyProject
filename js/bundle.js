...
function cards () {
    class MenuCard {
        constructor(src, alt, title, descr, price, parentSelector, ...classes) {
            ...
            this.convertionUAH = 27;
            this.changeToUAH();
        }

        changeToUAH() {
            this.price = this.price * this.convertionUAH;
        }
...
//always write in console npx json-server db.json
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-05-20 00:00');
